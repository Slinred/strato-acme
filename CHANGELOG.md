...
- dedicated shell script wrapper for acme.sh cron job inside VENV to ensure correct environment and path handling

### Changed

- moved to uv for python dependency management and installation in docker image
